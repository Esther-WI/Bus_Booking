...
Revision ID: 2cb725ab6a65
Revises: 
Create Date: 2025-07-29 14:22:51.002027
...
def upgrade():
    ...
    sa.Column('discount', sa.String(length=20), nullable=False),
    ...
    sa.Column('available_seats', sa.String(length=20), nullable=True),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=True),
    sa.ForeignKeyConstraint(['bus_id'], ['buses.id'], ),
